/*! sass.js - v0.0.0 - web worker - 2014-01-25 */
(function (root, factory) {
  ...
  Sass.initialize(src.replace(/\.worker\./, '.worker.task.'));;
  ...
  (function () {
    ...
    if (typeof window.scss == 'undefined') window.scss = {
      env: 'development'
    };
    ...
    function loadFile(originalHref, currentFileInfo, callback, env, modifyVars) {
      ...
      if (env.useFileCache && fileCache[href]) {
        try {
          ...
          callback(null, scssText, href, newFileInfo, {
